...
namespace WCSC
{
    public partial class Form1 : Form
    {
        ...
        private void pictureBox3_Click(object sender, EventArgs e)
        {
            try
            {
                string locationToSavePdf = Path.Combine(Path.GetTempPath(), "Spravka_PO_VU_KVKT.pdf");  // select other location if you want
                File.WriteAllBytes(locationToSavePdf, Properties.Resources.Spravka_PO_VU_KVKT);    // write the file from the resources to the location you want
